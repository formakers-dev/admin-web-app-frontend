    ...
    <div class="modal-card-body">
      <div class="columns" style="width: 100%; height: max-content">
        <div class="column">
          <div class="columns">
            <div class="column">
              <p class="request-classification-title">의뢰 관련 정보</p>
              <b-field>
                <template slot="label">
            ...
            <div class="column">
              <p class="request-classification-title">테스트 관련 정보</p>
              <b-field>
                <template slot="label">
            ...
            <div class="column">
              <p class="request-classification-title">게임 관련 정보</p>
              <b-field>
                <template slot="label">
            ...
            <div class="column">
              <p class="request-classification-title">회사 관련 정보</p>
              <b-field>
                <template slot="label">
            ...
            <div class="column">
              <p class="request-classification-title">의뢰자 관련 정보</p>
              <b-field>
                <template slot="label">
                  의뢰자 이름
                </template>
            ...
            <div class="column">
              <p class="request-classification-title">의뢰 상태 관련 정보</p>
              <b-field>
                <template slot="label">
                  운영담당자
